...
@section('content')
    <div>
        <a href="{{route(Session::get('userType') === "user" ? "index" : "user.index")}}"> Do your work, then step back. </a>
        <div class="">
                                ...
                                <div class="profile_img">
                                    <div id="crop-avatar">
                                        ...
                                        <img class="img-responsive avatar-view"
                                             src="{{asset('upload_file/user/'.$user->profile_photo)}}" alt="{{$user->name}}"
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <form action="{{route('user_details_update')}}"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="{{Session::get('userType') === "user" ? "col-md-7 col-sm-3" : "col-md-9 col-sm-9"}}">
                                                                <input type="email" class="form-control"
                                                                       value="{{$user->email}}"
                                                                       placeholder="Email" name="email" {{Session::get('userType') === "user" ? "readonly" : ""}}>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="{{Session::get('userType') === "user" ? "col-md-6 col-sm-3" : "col-md-9 col-sm-9"}}">
                                                                <input type="text" class="form-control"
                                                                       value="{{$user->mobile_no}}"
                                                                       placeholder="Mobile No" name="mobile_no" {{Session::get('userType') === "user" ? "readonly" : ""}}>
                                                            </div>
                                                            @if(Session::get('userType') === "user" )
                                                                <a class="border-button" href="javascript:;"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 col-sm-9 ">
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       placeholder="Aadhar No" name="aadhar_no" {{Session::get('userType') === "user" ? "readonly" : ""}}>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 col-sm-9 ">
                                                                <input id="dob" name="dob" value="{{$user->dob}}" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                                                                <script>
                                                                ...
                                                                <div class="col-md-55">
                                                                    <div class="thumbnail">
                                                                        <div class="image view view-first">
                                                                            <a href="{{asset('upload_file/user/user_document/'.$user->document_photo)}}" target="_blank">
                                                                                <img style="width: 100%; display: block;" src="{{asset('upload_file/user/user_document/'.$user->document_photo)}}" alt="image">
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                @if(Session::get('userType') !== "user" )
                                                                    <input  type="file" id="document_photo"  name="document_photo" accept="image/*" alt="{{$user->name}}">
                                                                @endif
                                                            </div>
