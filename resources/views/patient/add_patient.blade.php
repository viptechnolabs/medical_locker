    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 ">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form action="{{route('patient.submit_patient')}}" method="POST" enctype="multipart/form-data" id="add_patient">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6 offset-md-3">
                                <a href="{{route('patient.index')}}"><button class="btn btn-primary" type="button">Cancel</button></a>
